...
// // ✅ Axios instance (clean API calls)
...
//                         <tr key={item._id}>
//                           {/* <td>{item.clientId?.name || "N/A"}</td>
                         
//                           <td>{item.lawyerId?.name || "N/A"}</td> */}
//                           <td>
//   {item.clientId ? item.clientId.name : "❌ Client Deleted"}
// </td>

// <td>
//   {item.lawyerId ? item.lawyerId.name : "❌ Lawyer Deleted"}
// </td>
